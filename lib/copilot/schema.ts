// Portable schema; D1/SQLite is the zero-configuration local store. PostgreSQL
// uses the same model through the HTTP repository and a pgvector index.
export const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS cop_events (seq INTEGER PRIMARY KEY AUTOINCREMENT, tenant_id TEXT NOT NULL REFERENCES cop_tenants(id), consultation_id TEXT NOT NULL REFERENCES cop_consultations(id), type TEXT NOT NULL, data TEXT NOT NULL, timestamp TEXT NOT NULL)`,
